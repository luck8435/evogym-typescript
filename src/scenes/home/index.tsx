        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-sm">
              ...
              odit neque illum reiciendis! Doloremque error libero in quidem
              repellat ea quaerat nam, voluptatum voluptas explicabo
              reprehenderit, veritatis, consequatur debitis qui.
            </p>
          </motion.div>
